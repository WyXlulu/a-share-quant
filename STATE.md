...
- [x] Phase 1 后半段推进：第5步 EX-010 同轮次现金交互（2631183）、第6步 EX-008 容量约束（18f41c7）、第7步 EX-011~014 公司行动账本（82e2507）、DECISIONS 记 CA 简化（ab9e813）、第7.5步除权日涨跌停参考价清除 TODO（7b9c651）；`.venv\Scripts\python.exe run_tests.py` 全量 102 个测试全绿
...
1. 第8步：LT-002 Phase 1 作用域测试 + 端到端十年回测 runner（2015-07-01 至 2026-06-30，哑调仓策略，初始现金 100 万，每日会计恒等式校验，输出 `nav_daily` 与 `run_manifest` 标 `EXPLORATORY_TAINTED`）；通过后做全局扫描审查，Phase 1 毕业
